    ...
    <Modal transparent visible={visible} animationType="fade" onRequestClose={onClose}>
      <View style={styles.modalOverlay}>
        <View style={[styles.modalContainer, { maxWidth: 360 }]}>
          <View style={styles.modalContent}>
            <Text style={styles.modalTitle}>초대 확인</Text>
...
const styles = StyleSheet.create({
  ...
  searchLabel: { fontSize: sizes.normalText, fontFamily: FONTS.jamsil.medium4, color: colors.text.primary, marginBottom: 10 },
  ...
  modalTitle: { fontSize: sizes.smallTitle, fontFamily: FONTS.jamsil.bold5, color: colors.text.primary, textAlign: 'center', marginBottom: 8 },
  modalSubtitle: { fontSize: sizes.normalText, fontFamily: FONTS.jamsil.regular3, color: colors.text.secondary, textAlign: 'center', marginBottom: 24, lineHeight: sizes.normalText * 1.4 },
...
// // 목업 데이터
// const MOCK_USERS = [
//   { name: '김민수', phone: '01012345678', email: 'kim@example.com' },
//   { name: '이영희', phone: '01023456789', email: 'lee@example.com' },
//   { name: '박철수', phone: '01034567890', email: 'park@example.com' },
// ];
...
//     const phone = searchText.replace(/-/g, '');
//     const found = MOCK_USERS.filter(user => user.phone.includes(phone));
...
//     console.log('초대 전송:', selectedEmployees);
